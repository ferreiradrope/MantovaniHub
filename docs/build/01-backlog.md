...
\begin{tcolorbox}[colback=cremesuave,colframe=bordo,boxrule=0.8pt,sharp corners,coltitle=white,title=\textbf{Histórias incorporadas na Versão 2.0 (feedback do 2º encontro com o CEO)}]
As oito histórias a seguir endereçam diretamente os pontos levantados por Douglas: \textbf{alerta de
produção} (HU016), \textbf{resumo do mês} (HU017), \textbf{cadastro que gera estoque} (HU001 + HU009/HU019)
e \textbf{cardápio com ficha técnica e harmonização} (HU006/HU011), além de fundamentos de segurança,
relacionamento e configuração que sustentam a operação real.
\end{tcolorbox}
